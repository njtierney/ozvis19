...
```{r plot-sample-n}
heights %>% sample_n(5) %>% gg_heights() + geom_point()
```
...
.left-code[
```{r small-sample-add-real-data, eval = FALSE, echo = TRUE}
heights_sample +
  geom_point(
    aes(
...
.right-plot[
```{r small-sample-add-real-data-out, ref.label = 'small-sample-add-real-data', echo = FALSE, out.width = "100%"}
...
.left-code[
```{r plot-join-aug, eval = FALSE, echo = TRUE}
...
.right-plot[
```{r plot-join-aug-out, ref.label = 'plot-join-aug', echo = FALSE, out.width = "100%"}
